    ...
    <div className='response_container'>
      ...
      <div className='response-content'>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px' }}>
          ...
          <div style={{ gridRow: 'span 4', backgroundColor: 'white', boxShadow: '0 1px 10px rgba(50, 50, 50, 0.35)' }} className='bordered-sub-item'>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', paddingBottom: '30px' }}>
          ...
          <div className='bordered-sub-item' style={{ padding: '15px', boxShadow: '0 1px 10px rgba(50, 50, 50, 0.35)' }}>
