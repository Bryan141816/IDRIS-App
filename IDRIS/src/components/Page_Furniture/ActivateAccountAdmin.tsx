...
const AdminActivate = () => {
  ...
  const validateForm = () => {
    const { firstName, lastName, employeeIdNumber, contactNumber, lgu_id } =
      profileInfo;
  ...
  return (
    <div className={styles.activateFormContainer}>
      <div className={styles.profileForm}>
        ...
        >
          Please fill in your admin details below. Your account will be reviewed
          by a superadmin.
        </p>
        <form
          onSubmit={(e) => {
