          ...
          <div className="modal-content">
            <div className="modal-header">
              ...
              <div className="modal-action">
                ...
                <button type="submit" className="save-btn" onClick={() => navigate('/volunteer_management/organization_form')}><img src="/src/pages/volunteer_management/volunteer_dashboard/images/group.png" className="org-icon"/>{[...Array(4)].map((_, i) => (
      <span key={i}>&nbsp;</span>
    ))}As an Organization</button>
              </div>
          </div>
        </div>
      );
