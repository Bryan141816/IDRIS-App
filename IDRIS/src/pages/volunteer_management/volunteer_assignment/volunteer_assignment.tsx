...
const VolunteerAssignmentPage: React.FC = () => {
  const [volunteers] = useState<Volunteer[]>([
    {
      ...
      phone: '(555) 123-4567',
      skills: ['Event Setup', 'Registration', 'Communication'],
    ...
    },
    {
      ...
      email: 'bob@email.com',
      phone: '(555) 987-6543',
      skills: ['Food Service', 'Cleanup', 'First Aid'],
    ...
    },
    {
      ...
      phone: '(555) 456-7890',
      skills: ['Photography', 'Social Media', 'Registration'],
    ...
    },
    {
      ...
      phone: '(555) 321-0987',
      skills: ['Security', 'Crowd Control', 'Setup'],
      availability: ['All Days', 'Flexible'],
      status: 'available'
    }
  ]);
  ...
  const availableVolunteers = filteredVolunteers.filter(v => v.status === 'available');
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full transition-all ${
                            area.currentVolunteers >= area.maxVolunteers ? 'bg-red-500' : 'bg-blue-600'
                          }`}
