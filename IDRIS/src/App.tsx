      ...
      <div id="right-body-section">
        ...
        <main>
          <Routes>
            ...
            <Route
              path="/lgu_profiling/map_of_cebu"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/lgu_profiling/evacuationandshelter"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/lgu_profiling/LGUmanagement"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/lgu_profiling/LGUSeeMore/:lguName"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/volunteer_management/track_volunteer_application"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/volunteer_management/volunteer_dashboard"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/volunteer_management/organization_form"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/volunteer_management/otherorganization_form"
              element={
                <ProtectedRoute>
                  <Page title="IDRIS | Volunteer Application">
            ...
            />
            <Route
              path="/volunteer_management/individual_form"
              element={
                <ProtectedRoute>
                  <Page title="IDRIS | Volunteer Application">
                    <IndividualForm />
            ...
            />
            <Route
              path="/volunteer_management/otherindividual_form"
              element={
                <ProtectedRoute>
                  <Page title="IDRIS | Volunteer Application">
                    <OtherIndividualForm />
            ...
            />
            <Route
              path="/volunteer_management/manage_applicant"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/volunteer_management/view_credentials"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/volunteer_management/volunteer_profiles"
              element={
                <ProtectedRoute>
                  <Page title="IDRIS | Volunteer Profiles">
                    <VolunteerProfiles />
            ...
            />
            <Route
              path="/volunteer_management/manage_volunteers"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/donations_management/donations_dashboard"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/donations_management/list_of_rafi_donors"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/donations_management/funding_proposals"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/donations_management/funding_proposals/create"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/donations_management/funding_proposals/update"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/response_dashboard/report_list"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/response_dashboard/modality_distribution"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/procurement_inventory/procurement_inventory"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/procurement_inventory/distribution_planning"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/procurement_inventory/procurement_management"
              element={
                <ProtectedRoute>
