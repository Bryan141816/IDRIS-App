      ...
      <div id="nav-links">
        ...
        {userRoles.includes("lgu officer") && (
          <div className="nav-items" id="procurement_request">
            <div
              className={`flex-control ${
                activeNav === "procurement_request" ? "active" : ""
              }`}
        ...
        {userType === "admin" && (
          <div className="nav-items" id="user_management">
            <div
              className={`flex-control ${
                activeNav === "user_management" ? "active" : ""
              }`}
