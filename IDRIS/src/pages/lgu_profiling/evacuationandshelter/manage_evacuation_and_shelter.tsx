...
const EvacuationAndShelter = () => {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        try {
            ...
            if (payload.occupied < 0 || payload.capacity < 0) { await Swal.fire("Error", "Capacity and occupied must be non-negative.", "error"); return; }
            if (payload.occupied > payload.capacity) { await Swal.fire("Error", "Occupied cannot exceed capacity.", "error"); return; }
            if (editingId) {
            ...
            setCenterForm({ name: "", capacity: 0, occupied: 0, lat: 0, lng: 0 });
            setEditingId(null);
            fetchShelters();
        } catch {
        ...
        <main className="dashboard-container">
            ...
            <section className="quick-actions">
                ...
                <div className="action-buttons">
                    <button className="action-btn primary admin-only" onClick={() => scrollToSection(evacuationCenterRef)}>
                    ...
                    <button className="action-btn secondary" onClick={() => navigate("/lgu_profiling/shelter_report_dashboard")}>
            ...
            <div className="content-grid">
                        ...
                        <div className="map-container">
                            <div className="maps-placeholder">
                                <MapView
                                    ...
                                    markers={shelters.map(({ lat, lng }) => ({ lat, lng }))}
                ...
                <div className="right-column">
                    <section className="evacuation-center-form admin-only" ref={evacuationCenterRef}>
                        <div className="section-header">
                            <h2><i className="fas fa-edit"></i>&nbsp;Register Evacuation Center</h2>
                        </div>
                        <form className="center-form" onSubmit={handleSubmit}>
                            <div className="form-group">
                                <label>Center Name</label>
                                <input type="text" name="name" placeholder="Enter evacuation center name" value={centerForm.name} onChange={handleFormChange} required />
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-row">
                                <div className="form-group">
                                    ...
                                    <input type="number" name="capacity" placeholder="Max capacity"
                                        min={0} value={centerForm.capacity} onChange={handleFormChange}
                                        style={{ width: "210%" }} />
                                </div>
                            </div>
