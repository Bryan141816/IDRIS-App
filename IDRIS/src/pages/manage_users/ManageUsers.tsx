                    ...
                    <span
                        style={{
                            ...
                            color: status === "Active" ? "#10b981" :
                                status === "Pending Approval" ? "#ef4444" :
                                    status === "Incomplete Profile" ? "#f59e0b" : "#6b7280"
                        }}
                    >
                        {status}
                    </span>
                ...
                {isAdmin && adminProfileData && (
                    <>
                        ...
                        <div className="horizontal-container">
                            ...
                            <span>{adminProfileData.first_name} {adminProfileData.last_name}</span>
                        </div>
                        <div className="horizontal-container">
                        ...
                        <div className="horizontal-container">
                            <span className="item-details-identifier">LGU Location:</span>
                            <span>{adminProfileData.lgu_location}</span>
                        </div>
                        ...
                        <button
                            ...
                            onClick={() => {
                                setMessageBox((prev) => ({
                                    ...
                                    onSubmit: () => handleApproveAdmin(isViewModalSelected.data[0].text),
                                }));
                            }}
                        >
                            Approve Admin
