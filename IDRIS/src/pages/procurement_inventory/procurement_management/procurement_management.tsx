      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            <h3>
              {
                procurementRequests.filter((r) => r.status === "Approved")
                  .length
              }
            </h3>
            <p>Approved</p>
    ...
    <div className="approvals-content">
      <div className="section-header">
        ...
        <div className="header-actions">
          ...
          <button
            className="primary-btn"
            onClick={() => openModal("approval-settings")}
          >
            ⚙️ Settings
          </button>
        </div>
      ...
      <div className="approval-queue">
        <h3>
          Pending Approvals (
          {
            procurementRequests.filter((r) => r.status === "Pending Approval")
              .length
          }
          )
        </h3>
                ...
                .map((request) => (
                  <tr key={request.id}>
                    ...
                    <td>
                      <button
                        className="action-btn"
                        onClick={() => openModal("quick-approve", request)}
                      >
                        Quick Review
                      </button>
                    </td>
    ...
    <div className="notifications-content">
      <div className="section-header">
        ...
        <div className="header-actions">
          <button
            className="secondary-btn"
            onClick={() => openModal("mark-all-read")}
          >
            ✓ Mark All Read
          </button>
          <button
      ...
      <div className="notifications-detailed">
        {notifications.map((notification) => (
          <div
            key={notification.id}
            className={`notification-detail ${notification.read ? "read" : "unread"}`}
          >
          ...
          <div className="modal-actions">
            ...
            {modalType !== "view-request" && (
              <button className="primary-btn">
                {modalType === "approve-request"
                  ? "Approve"
                  : modalType === "reject-request"
                    ? "Reject"
                    : "Save"}
              </button>
            )}
