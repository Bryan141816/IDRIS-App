  ...
  datasets: [
    {
      ...
      data: [
        52.8, 58.3, 61.1, 65.6, 69.3, 72.2, 75.0, 80.6, 83.3, 79.4, 72.2, 61.1,
      ],
          ...
          <section className="map-section">
            ...
            <div className="map-container">
              <div className="maps-placeholder">
                <MapView center={[10.313924, 123.887082]} markers={[]} />
              </div>
            ...
            <form className="center-form">
              ...
              <div className="form-group">
                ...
                <div className="checkbox-group">
                  <label>
                    <input type="checkbox" /> Medical Station
                  </label>
                  <label>
                    <input type="checkbox" /> Kitchen
                  </label>
                  <label>
                    <input type="checkbox" /> Restrooms
                  </label>
                  <label>
                    <input type="checkbox" /> Children's Area
                  </label>
                </div>
              </div>
        ...
        <div className="shelter-list">
          <div className="shelter-item">
            <div className="shelter-info">
              ...
              <p>
                <i className="fas fa-map-marker-alt"></i> 123 Main St, Downtown
              </p>
          ...
          <div className="shelter-item">
            <div className="shelter-info">
              ...
              <p>
                <i className="fas fa-map-marker-alt"></i> 456 Oak Ave, East
                District
              </p>
              <p className="barangay-info">
        ...
        <div className="report-content">
          ...
          <div className="utilization-chart">
            ...
            <div
              ...
              style={{ maxWidth: "100%", marginTop: "1rem", height: "350px" }}
            >
