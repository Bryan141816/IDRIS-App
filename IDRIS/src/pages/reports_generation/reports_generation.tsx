...
const ReportsGeneration = () => {
  ...
  const [activeReports, setActiveReports] = useState<Report[]>([
    {
      ...
      description: "Comprehensive sales analysis for the third quarter",
      type: "Sales",
      date: "2024-10-15",
      status: "completed",
      size: "2.4 MB",
    },
    {
      ...
      description: "User behavior and engagement metrics for September",
      type: "Analytics",
      date: "2024-10-14",
      status: "processing",
      size: "1.8 MB",
    },
    {
      ...
      description: "Q3 financial statements and performance indicators",
      type: "Financial",
      date: "2024-10-13",
      status: "completed",
      size: "3.2 MB",
    ...
    },
    {
      ...
      description: "Consolidated user feedback and satisfaction scores",
      type: "Analytics",
      date: "2024-10-10",
      status: "processing",
      size: "0.8 MB",
  ...
  const processingCount = activeReports.filter(
    (r) => r.status === "processing",
  ).length;
  const completedCount = [...activeReports, ...archivedReports].filter(
  ...
  const currentReports =
    viewMode === "active" ? activeReports : archivedReports;
  ...
  const handleArchive = (reportId: number) => {
    ...
    if (reportToArchive) {
      ...
      setArchivedReports([
        ...archivedReports,
        { ...reportToArchive, archivedDate: new Date().toISOString() },
      ]);
    }
  };
      ...
      <div className="reports-container">
        ...
        {viewMode === "archived" && archivedReportsCount > 0 && (
          <div className="archive-info-banner">
            <Archive size={20} />
            <span>
              These reports have been archived and are no longer active. You can
        ...
        <div className="reports-list">
          {filteredReports.length > 0 ? (
            filteredReports.map((report) => (
              <div
                key={report.id}
                className={`report-card ${viewMode === "archived" ? "archived" : ""}`}
              >
                  ...
                  <div className="report-actions">
                    ...
                    {viewMode === "active" ? (
                      ...
                      >
                        <ArchiveRestore
                          size={18}
                          className="unarchive-button-icon"
                        />
                      </button>
                    )}
                    <button
