...
const Register: React.FC = () => {
  ...
  const doRegister = async (
    ...
    try {
      const response = await fetch("https://idris-app.onrender.com/register", {
        method: "POST",
        headers: {
  ...
  const handleGoogleLogin = () => {
    window.location.href = "https://idris-app.onrender.com/auth/register";
  };

  const handleMicrosoftLogin = () => {
    window.location.href =
      "https://idris-app.onrender.com/auth/microsoft/register";
  };
