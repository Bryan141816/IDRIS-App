...
const ListOfRAFIDonors = () => {
  ...
  const [donors, setDonors] = useState<DonorData[]>([]); // Donor Data State
    ...
    async function fetchDonors(){
      try{
        ...
        if (Array.isArray(response)) {
          ...
          // If response is an object with donors property
  ...
  const tableData: TableResponse = {
    ...
    table_datas: donors.map((donor: DonorData, index: number) => ({
      data: [
        {
          type: 'Text' as const,
